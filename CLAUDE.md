...
- The weekly harness review is `home/claude/skills/propose-harness/`. Register it in the Cursor dashboard with `AUTOMATION.md` in that directory; this repo does not create the dashboard object.
